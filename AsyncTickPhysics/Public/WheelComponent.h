...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|TireModel")
	float SlipRelaxationSpeed = 10.0f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|Stability", meta=(EditCondition="bEnableStationaryHold"))
	float StationaryHoldVelocityDamping = 5200.0f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|Stability", meta=(EditCondition="bEnableStaticFrictionLock"))
	float StaticLockAngularThreshold = 2.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|Stability", meta=(EditCondition="bEnableStaticFrictionLock"))
	float StaticLongitudinalDamping = 4200.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|Stability", meta=(EditCondition="bEnableStaticFrictionLock"))
	float StaticLateralDamping = 4600.0f;


	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wheel|Stability")
	float HandbrakeLongitudinalDragMultiplier = 3.5f;
